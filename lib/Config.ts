...
export class Config implements IConfig {
    /**
     * The amount of decimal places your coin has, e.g. cuddlecoin has eight
     * decimals
     */
