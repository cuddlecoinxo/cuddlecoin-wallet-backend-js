...
export declare interface WalletBackend {
     ...
     *
     * This block object is an instance of the [Block cuddlecoin-utils class](https://utils.turtlecoin.dev/classes/block.html).
     ...
     * cache daemons should support this).
     *
     * This transaction object is an instance of the [Transaction cuddlecoin-utils class](https://utils.turtlecoin.dev/classes/transaction.html).
     * See the Utils docs for further info on using this value.
     *
